    ...
    <main className="page-route">
      <section className="page-hero">
        <div className="container">
          ...
          <p className="lede">
            Восемь человек, 15 лет в фарм-маркетинге РБ, 80+ запусков, своя AI-лаборатория и собственный
            справочник, которым пользуется тысяча врачей. Цель — лечение доверия в здравоохранении.
          </p>
          <div style={{ marginTop: 24, display: 'flex', gap: 10, flexWrap: 'wrap' }}>
