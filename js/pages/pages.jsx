  ...
  const features = en ? en.features : [
    {
      ...
      dParagraphs: [
        [
          { s: 'Это не просто база данных, а современная цифровая экосистема, созданная для оптимизации ежедневной работы медицинских и аптечных специалистов. Проект начал свою официальную работу 1 сентября 2025 года с миссией сформировать единое пространство проверенной, структурированной и практически применимой медицинской информации.' },
        ],
        [
          { s: 'Мы объединили фундаментальные знания с передовыми IT-технологиями, чтобы процесс принятия клинических решений стал быстрее и безопаснее. Базовой единицей наших данных является официальная инструкция по медицинскому применению и общая характеристика лекарственного препарата (ОХЛП) — документы, на которые специалисты опираются при назначении, отпуске и консультировании.' },
        ],
        [
          { s: 'В Справочнике интегрированы актуальные клинические протоколы, примеры оформления рецептов на латыни, материалы по фармакологии и обширный пакет медицинских калькуляторов.' },
        ],
        [
          { s: 'Флагманское направление нашей работы — сервис «ИИ-фармаколог». Интеллектуальный ассистент мгновенно оценивает риски межлекарственных взаимодействий на основе международных баз данных, страхуя врача от ошибок полипрагмазии и экономя время на поиске информации.' },
        ],
      ],
    },
    {
      ...
      dParagraphs: [
        [
          { s: 'Справочник ЛС ФармКонсилиум — это проект, который развивается вместе с медицинским сообществом. Мы ищем практикующих врачей, готовых делиться опытом и создавать полезные цифровые инструменты для коллег.' },
        ],
        [
          { s: 'Как мы можем сотрудничать:' },
        ],
        [
          { s: 'Публикация контента: Размещайте авторские клинические разборы, образовательные модули и практические рекомендации, которые помогают принимать обоснованные решения у постели больного.' },
        ],
        [
          { s: 'Цифровизация ваших научных трудов: У вас есть авторская медицинская шкала, алгоритм или расчетная модель из диссертации? Наши IT-специалисты превратят их в удобные интерактивные калькуляторы с обязательным указанием вашего авторства.' },
        ],
        [
          { s: 'Экспертиза: Подскажите, каких разделов или калькуляторов не хватает в вашей специальности, и мы реализуем это вместе.' },
        ],
        [
          { s: 'Давайте создавать инструменты, которые отражают реальные потребности практикующих врачей. Напишите нам, чтобы обсудить ваши идеи.' },
        ],
      ],
    },
    {
      ...
      dParagraphs: [
        [
          { s: 'Специалисты аптечного звена ежедневно работают с огромным массивом данных: от проверки совместимости препаратов до консультирования пациентов у первого стола. Мы хотим, чтобы Справочник ЛС ФармКонсилиум стал вашим главным помощником в этой рутине.' },
        ],
        [
          { s: 'Уже сейчас сотни провизоров используют наш ресурс, но сделать его по-настоящему прикладным мы можем только вместе с вами.' },
        ],
        [
          { s: 'Чем вы можете поделиться:' },
        ],
        [
          { s: 'Идеями по улучшению: Подскажите, как сделать карточки препаратов, справочники взаимодействий и примеры рецептов удобнее для быстрой работы в аптеке.' },
        ],
        [
          { s: 'Авторскими материалами: Мы готовы публиковать ваши памятки, алгоритмы фармконсультирования и разборы частых вопросов от пациентов (замены, безопасность, отпуск).' },
        ],
        [
          { s: 'Давайте вместе создадим ресурс, который помогает быстро находить точную информацию и уверенно применять её в ежедневной работе. Напишите нам!' },
        ],
      ],
    },
    {
      ...
      dParagraphs: [
        [
          { s: 'Это экспертная площадка, где ваш портфель интегрирован в интерфейс, адаптированный под ежедневную рутину врача, провизора и фармацевта. В нашей системе приоритет отдается не рекламным лозунгам, а клинической ценности, точности данных и их удобному представлению в момент принятия решения о назначении или отпуске препарата.' },
        ],
        [
          { s: 'Мы предлагаем партнерам глубокую структуризацию данных: от размещения ОХЛП и базовой фармакологической информации до разработки корректных шаблонов медицинских рецептов и др. Для компаний, работающих на нескольких рынках СНГ, реализован уникальный мультирыночный формат. Он позволяет представлять локальные версии инструкций для разных стран, учитывая все регуляторные различия, и поддерживать актуальность портфеля для каждого региона присутствия.' },
        ],
        [
          { s: 'Весь контент проходит строгую верификацию редакционной коллегией, состоящей из практикующих врачей и клинических фармакологов. На карточках препаратов может фиксироваться дата последнего обновления данных, что обеспечивает прозрачность и формирует высокий уровень доверия профессионального сообщества к вашему бренду. Мы приглашаем к сотрудничеству производителей, нацеленных на ответственное и качественное представление своих лекарственных средств в цифровой среде.' },
        ],
      ],
    },
  ];
