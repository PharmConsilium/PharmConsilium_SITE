...
function ContentPage({ navigate, lang }) {
  ...
  lede: 'Создаём цифровой медицинский контент: презентации лекарственных средств, экспертные видео, квизы, викторины, клинические детективы, игровые механики и геймифицированные образовательные проекты.',
