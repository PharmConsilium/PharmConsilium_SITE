...
function HcpPage({ navigate, lang }) {
  ...
  { title: 'ИИ-ассистенты и рекомендательные системы', sub: 'ai-recom', size: 'huge', art: 'ArtAI',
    desc: 'LMS для HCP: вебинары, курсы, тренинги и аттестация на собственных платформах.',
    tag: 'CME · MedicalEducation' },
  { title: 'Образовательные платформы', sub: 'education', art: 'ArtBooks',
    desc: 'LMS для HCP и пациентов: вебинары, курсы, CME, прогресс и сертификаты в одной среде.',
    tag: 'LMS · CME · PSP' },
  { title: 'Чат-бот и ТелеАпп', sub: 'chatbot', art: 'ArtChat',
    desc: 'ИИ-боты для HCP и пациентов: терапия, навигация, фармаконадзор 24/7.',
    tag: 'MedicalAI · HealthcareBot' },
  ...
  { title: 'Программы поддержки пациентов', sub: 'psp', art: 'ArtPulse', size: 'wide',
    desc: 'RWE-платформы: сбор и анализ реальных данных, когортная аналитика, ИИ и контракты на основе результатов.',
    tag: 'RWE · ClinicalData' },
...
function SalesPage({ navigate, lang }) {
  ...
  { title: 'Цифровой медицинский представитель в гибридной продвижении фармбрендов', sub: 'omnichannel', art: 'ArtNodes',
