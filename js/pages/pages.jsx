...
function DirectoryPage({ navigate, lang }) {
  ...
  const features = en ? en.features : [
    ...
    },
    {
      ...
      art: 'ArtDoc',
      artImg: 'assets/uploads/directory-collab-doctors.jpg',
      artImgAlt: 'Команда врачей',
      dParagraphs: [
        [
