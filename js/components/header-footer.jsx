...
const MEGA = {
  ...
  design: {
    ...
    featured: {
      ...
      title: 'ИИ-«говорящая голова» и видеоаватары',
      desc: 'Цифровой аватар, который говорит с аудиторией про ваши бренды. Скопируем ваш SF и преобразуем в цифровой формат.',
