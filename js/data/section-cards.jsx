...
const SECTION_CARDS = {
  pharma-marketing: [
    ...
    { title: 'CLM — ПО для работы МП F2F с промоконтентом', sub: 'clm',
      ...
      tag: 'CLM, CLM-Presentation, Detailing CLM' },
    ...
    { title: 'Чат-бот и ТелеАпп — цифровая экосистема для коммуникации с HCP', sub: 'chatbot-teleapp', art: 'ArtChat',
      ...
      cardArtPhoto: 'contain',
      desc: 'Создание уникальной цифровой архитектуры в мессенджере Телеграм для долгосрочной коммуникации с вашими клиентами, где в списке личных чатов пользователя находится чат-бот с встроенными функциями мобильного приложения.',
      tag: 'TelegramBot, TeleApp, ChatBot' },
    { title: 'Веб-разработка: сайты, лендинги, лонгриды, платформы для онлайн-конгрессов и вебинаров', sub: 'web-development', art: 'ArtBrowser', size: 'wide',
    ...
    { title: 'Разработка мобильных приложений', sub: 'mobile-apps', art: 'ArtPhone', size: 'wide',
      ...
      cardArtPhoto: 'contain',
      desc: 'Создание mHealth-приложений для фармбрендов «под ключ» — от идеи и UX-концепции до дизайна, разработки и публикации в App Store и Google Play.',
      tag: 'iOS, Android, PharmaApp' },
    { title: 'Цифровая поддержка мероприятий', sub: 'event-support', art: 'ArtRadar',
    ...
    { title: 'Тренинги для медицинских представителей', sub: 'rep-training', art: 'ArtAI',
      ...
      cardArtPhoto: 'contain',
      desc: 'Более 30 тренинговых тем для медицинских представителей, реализованных за несколько десятилетий от ФармКонсилиум: виртуальный видеозал, квиз-тренажёры и 10 готовых ролевых игр с геймификацией под бренд клиента.',
  ...
  healthcare: [
    ...
    { title: 'Программы поддержки пациентов', sub: 'patient-support', art: 'ArtBooks',
      ...
      cardArtPhoto: 'cover',
      desc: 'Мобильное приложение-companion, HUB-/access-платформа (patient support CRM), система удалённого мониторинга (RPM/IoT), телемедицина, интеграции с ЕМК/EHR, аналитика/BI-платформа.',
      tag: 'PatientSupport, DigitalHealth, PSP' },
    { title: 'Чат-боты и ИИ-ассистенты для медицины', sub: 'medical-chatbots', art: 'ArtChat',
    ...
    { title: 'Цифровые платформы для научных исследований', sub: 'research-platforms', art: 'ArtDashboard',
    ...
    { title: 'Создание систем анализа и обработки данных RWE', sub: 'rwe-analytics', art: 'ArtPulse', size: 'wide',
  ...
  outsourcing: [
    ...
    { title: 'Лонч-аутсорсинг', sub: 'launch-outsourcing', art: 'ArtLaunch',
      ...
      cardArtPhoto: 'contain',
      desc: 'Лонч-аутсорсинг с ФармКонсилиум: от стратегии и софт-лонча до цифрового лонча и полного комплекса сервисов вывода бренда на рынок Беларуси. Воспользуйтесь нашей базой HCP и цифровыми инструментами продвижения для быстрого старта вашего бренда на новом фармрынке.',
      tag: 'PharmaLaunch, SoftLaunch, LaunchOutsourcing' },
  ],
  design: [
    { title: 'CLM-презентации, детейлеры, слайдбоксы для медицинского представителя', sub: 'clm-presentations', size: 'huge', art: 'ArtDoc',
      cardArt: 'assets/uploads/content-medical-card.png?v=20260528',
      cardArtAlt: 'CLM-презентации и детейлеры: карточка с иллюстрацией контента для медицинского представителя',
      cardArtPhoto: 'cover',
    ...
    { title: 'Видео HCP - от сценария до спецэффектов в выступлении OL', sub: 'hcp-video', art: 'ArtVideo', size: 'wide',
      cardArt: 'assets/uploads/content-video-card.png?v=20260528',
      cardArtAlt: 'Видео HCP: карточка с иллюстрацией видеопродакшна и клинических спецэффектов',
      cardArtPhoto: 'cover',
    ...
    { title: 'Игры, квизы и клинические детективы для HCP', sub: 'games-quizzes', art: 'ArtGame', size: 'wide',
      cardArt: 'assets/uploads/content-gamification-card.png?v=20260528',
      cardArtAlt: 'Игры и квизы для HCP: карточка с иллюстрацией геймификации и клинических кейсов',
      cardArtPhoto: 'cover',
    ...
    { title: 'Визуальные концепты, упаковка, рекламные баннера, брендбук ЛС', sub: 'brand-packaging', art: 'ArtSlides',
      cardArt: 'assets/uploads/content-presentations-card.png?v=20260528',
      cardArtAlt: 'Визуальные концепты и бренд-дизайн: карточка с иллюстрацией упаковки и рекламных материалов',
      cardArtPhoto: 'cover',
    ...
    { title: 'ИИ-контент: аватары, аудио-подкасты, медицинский копирайтинг', sub: 'ai-content', art: 'ArtBrowser',
      cardArt: 'assets/uploads/content-ai-card.png?v=20260528',
      cardArtAlt: 'ИИ-контент: карточка с иллюстрацией аватаров, подкастов и медицинского копирайтинга',
      cardArtPhoto: 'cover',
