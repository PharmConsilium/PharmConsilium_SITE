...
const UI_RU = {
  home: 'Главная',
  contacts: 'Контакты',
  brandAlt: 'ФармКонсилиум — IT-решения для фармацевтического маркетинга',
  openMenu: 'Открыть меню разделов',
  closeMenu: 'Закрыть меню разделов',
  navAria: 'Разделы сайта',
  themeLight: 'Светлая тема',
  themeDark: 'Тёмная тема',
  themeLightSystem: 'Светлая тема (сейчас как в системе)',
  themeDarkSystem: 'Тёмная тема (сейчас как в системе)',
  themeHoldSystem: 'Удержите, чтобы снова следовать теме системы',
  ...
  detailPortfolioCases: 'Примеры из портфолио',
  detailPortfolioExample: 'Пример из портфолио',
...
const UI_EN = {
  ...
  themeLightSystem: 'Light theme (following system)',
  themeDarkSystem: 'Dark theme (following system)',
  themeHoldSystem: 'Hold to follow system theme again',
  ...
  detailPortfolioCases: 'Cases from our portfolio',
  detailPortfolioExample: 'Portfolio example',
