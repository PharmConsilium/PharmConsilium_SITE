...
const UI_RU = {
  ...
  detailCtaH3: 'Готовы обсудить?',
  detailCtaP: 'Покажем кейсы, разложим бюджет и сроки, дадим пилот за 2 недели.',
  detailCases: 'Кейсы · PDF',
  detailRelated: 'Смотрите также',
...
const UI_EN = {
  ...
  detailCtaH3: 'Ready to talk?',
  detailCtaP: 'We\'ll walk you through cases, budget and timeline, and offer a two-week pilot.',
  detailCases: 'Cases · PDF',
  detailRelated: 'Related',
