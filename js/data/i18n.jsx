...
const UI_RU = {
  ...
  detailCtaH3: 'Начнём обсуждение сейчас',
  detailCtaP: 'Воспользуйтесь формой быстрой связи — кнопка «Контакты»',
...
const UI_EN = {
  ...
  detailCtaH3: 'Let\'s start the conversation now',
  detailCtaP: 'Use the quick contact form — the Contacts button',
