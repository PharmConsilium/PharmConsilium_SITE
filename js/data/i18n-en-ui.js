...
window.I18N_EN = {
  ...
  team: {
    ...
    members: [
      ...
      { n: 'Valeria Povshok', r: 'Medical marketing manager' },
      { n: 'Nikolay Kuzmitsky', r: 'Digital ecosystem marketer' },
      { n: 'Sergey Malanchuk', r: 'Software engineer' },
      { n: 'Ilya Urbanovich', r: 'AI video design, animation' },
      { n: 'Artyom Olenik', r: 'Cross-platform systems design' },
      { n: 'Vladislav Zyabochkin', r: 'Head of IT development' },
      { n: 'Oksana Nevgen', r: 'Finance' },
      { n: 'Vladimir Borisuk', r: 'Optimist' },
    ],
