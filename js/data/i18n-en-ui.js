...
window.I18N_EN = {
  ...
  mega: {
    marketing: {
      ...
      featured: {
        tag: 'Tool',
        title: 'AI trainer for medical representatives',
        desc: 'Hybrid training on real visit scenarios: HCP simulator, AI feedback, and progress metrics.',
        art: 'ArtAI',
      },
    },
    hcp: {
      ...
      featured: {
        tag: 'Platform',
        title: 'Personalized content path for physicians',
        desc: 'A recommendation engine surfaces relevant publications, video, and updates for each specialist profile.',
        art: 'ArtPulse',
      },
    },
    sales: {
      ...
      featured: {
        tag: 'Service',
        title: 'New brand launch in 90 days',
        desc: 'Use our HCP client base and tooling for a fast start in the Belarus market.',
        art: 'ArtLaunch',
      },
    },
    content: {
      ...
      featured: {
        ...
        desc: 'Ready-made video and animation: 3D MOA visualization, AI avatars in 12 languages, scripted series.',
        art: 'ArtVideo',
      },
    },
    directory: {
      ...
      featured: {
        tag: '1000+ specialists · daily',
        title: 'Residency-grade architecture — without the noise',
        desc: 'Content that supports real clinical decisions. Access for physicians and pharmacists.',
        art: 'ArtDirectory',
      },
    },
    team: {
      title: 'We make the world better!',
      links: [
      ...
      featured: {
        tag: 'Team',
        title: 'Treating trust — our work',
        desc: '15 years in pharma marketing, 80+ launches, expertise across Belarus and the CIS.',
    ...
    marketing: {
      ...
      cards: [
        { title: 'CRM', sub: 'crm', size: 'huge', art: 'ArtNodes',
          desc: 'For medical representatives and omnichannel digital engagement with HCPs. Segmentation, visit scenarios, channel orchestration, and reporting for brand teams.',
          tag: 'Veeva, IQVIA, Pitcher' },
        { title: 'CLM', sub: 'clm', art: 'ArtLayers',
          desc: 'Interactive visit presentations. Deployed to Veeva, IQVIA, Agnitio, and Pitcher.',
          tag: 'visit, content' },
        ...
        { title: 'Digital event support', sub: 'events', art: 'ArtRadar',
          ...
          tag: 'congresses' },
        { title: 'AI solutions', sub: 'ai', art: 'ArtAI',
          desc: 'AI coach for reps, AI assistants, survey and business analytics platforms, AI consulting.',
          tag: 'AI · 2026' },
      ],
    },
    hcp: {
